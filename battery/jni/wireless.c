...
void activate_wireless_suggestion(void)
{
	...
	system(line);
	printf ("[batd] activate_wireless, sacrifice network performance to save powe \n");
}
void activate_wireless_suggestion_new(void)
{
	...
	fprintf(file,"1\n");
	fclose(file);
	printf ("[batd] activate_wireless_new, sacrifice network performance to save powe \n");
}
...
{	
	...
	fprintf(file,"1\n");
	fclose(file);
	printf ("[batd] activate_rfkill, Disable the unused WIFI radio\n");
}
void suggest_wireless_powersave(void)
{
	...
	printf ("[batd] inside suggest_wireless_powersave = %d\n", ret);
